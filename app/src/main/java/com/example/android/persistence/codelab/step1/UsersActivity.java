...
//        List<User> youngUsers = mDb.userModel().findUsersYoungerThan(40);
//        for (User youngUser : youngUsers) {
//            sb.append(String.format(Locale.US,
//                    "%s, %s (%d)\n", youngUser.lastName, youngUser.name, youngUser.age));
//        }

        List<Book> booksBorrowedBy = mDb.bookModel().findBooksBorrowedByNameSync("Mike");
        for (Book book: booksBorrowedBy){
